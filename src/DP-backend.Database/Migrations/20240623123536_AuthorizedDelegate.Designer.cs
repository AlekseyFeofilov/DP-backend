...
namespace DP_backend.Database.Migrations
{
    ...
    [Migration("20240623123536_AuthorizedDelegate")]
    partial class AuthorizedDelegate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DP_backend.Common.EntityType.EntityType", b =>
                {
            ...
            modelBuilder.Entity("DP_backend.Domain.Employment.CourseWorkRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DP_backend.Domain.Employment.Employer", b =>
                {
                    ...
                    b.Property<string>("AuthorizedDelegate")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DP_backend.Domain.Employment.InternshipDiaryRequest", b =>
                {
                    ...
                    b.Property<string>("ManagerFromEmployment")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("StudentIndividualTask")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DP_backend.Domain.Employment.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DP_backend.Domain.Templating.DocumentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<TemplateContext>("BaseTemplateContext")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("DP_backend.Domain.Templating.DocumentTemplate", b =>
                {
                    b.HasOne("DP_backend.Domain.FileStorage.FileHandle", null)
                        .WithMany()
